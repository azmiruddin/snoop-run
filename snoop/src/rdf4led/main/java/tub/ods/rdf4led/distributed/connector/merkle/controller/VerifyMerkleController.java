package tub.ods.rdf4led.distributed.connector.merkle.controller;
...
public class VerifyMerkleController {

    private static final Logger LOGGER = LoggerFactory.getLogger(VerifyMerkleController.class);
